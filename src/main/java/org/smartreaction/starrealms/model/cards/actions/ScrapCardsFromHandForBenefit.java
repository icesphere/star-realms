...
import org.smartreaction.starrealms.model.cards.ScrapCardsForBenefit;
...
public class ScrapCardsFromHandForBenefit extends Action {
    private ScrapCardsForBenefit card;
    private int numCardsToScrap;

    private List<Card> selectedCards = new ArrayList<>();

    public ScrapCardsFromHandForBenefit(ScrapCardsForBenefit card, int numCardsToScrap, String text) {
        this.card = card;
